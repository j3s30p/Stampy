...
| `docs/glossary`       | README/AGENTS/CLAUDE/.ai-\* |
...
2. ESLint / Prettier 위반이면 → [`static-analysis-guide`](./static-analysis-guide.md) 의 표에서 룰 ID 검색.
...
- 룰 ID 별 의도: `.ai-skills/static-analysis-guide.md`
- ADR (왜 이 워크플로우): `.ai-background/02-architecture-decisions.md` ADR-008 + 본 PR (`harness/lock-ai-merge`)
